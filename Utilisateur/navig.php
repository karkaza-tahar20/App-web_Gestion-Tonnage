                       ...
                       <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>     
                                        <li>+(212) 611-484-060</li>
                                        <li>OCP@Domain.com</li>
                                        <li>Mon - Sat 8:00 - 18:30, Sunday - CLOSED</li>
                                    </ul>
                                </div>
                        ...
                        <div class="row align-items-center">
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav> 
                                        <ul id="navigation">                                                                                                                   
                                            ...
                                            <li><a href="rechercheTrain.php">Recherche</a></li>
                                              <!--<li><a href="#"></a></li>
                                           <li><a href="#"></a>
                                                <ul class="submenu">
                                                    <li><a href="#">Blog</a></li>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-3">
                                <div class="header-right-btn f-right d-none d-lg-block">
                                    <a href="../ADMIN/deconnexion.php" class="btn">Deconnexion </a>
                                </div>
                            </div>
                            <!-- Mobile Menu -->
                            <div class="col-12">
