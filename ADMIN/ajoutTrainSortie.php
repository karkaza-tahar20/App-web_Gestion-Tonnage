 ...
 <html>
 <head>
   <title>AJOUTER UN Train Sortie</title>
          ...
          <form method="post" action="addTrainSortie.php" enctype="multipart/form-data" >
              ...
              <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" name="Matricule"  placeholder="Matricule" required="True">
                    </div>
                    <div  class="form-group col-md-6">
                      <label>Adresse Capteur </label>
                      <input type="text" class="form-control" name="Adresse_Capteur" placeholder="Adresse Capteur" required="True">
                    </div> 
              </div>
              <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>Poids </label>
                        <input type="text" class="form-control" name="Poids" placeholder="Poids" required="True">
                    </div>
                    <div class="form-group col-md-6">
                      <label>La destination</label>
                      <input type="text" class="form-control" name="Destination" placeholder="Destination " required="True">
                    </div><br /> 
              </div>
              <!--<div class="form-row">
               ...
               <div class="form-row">
                    <div class="form-group col-md-6">
                      <label>L'heur</label>
                      <input type="time" class="form-control" name="Heur" placeholder="Heur de sortie" required="True">
                    </div><br /> 
                     <div class="form-group col-md-6">
                      <label>Date de sortie </label>
                      <input type="date" class="form-control" name="Date" placeholder="Date de sortie" required="True">
                    </div>
               </div>
               <div class="form-row">
                       <?php 
